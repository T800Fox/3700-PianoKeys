...
module sequencer #(
    ...
    initial begin
        ...
        $readmemh("midi_data/gy.txt", sequence_data, 1*SONG_MEM_SIZE);
        $readmemh("midi_data/gy.txt", sequence_data, 2*SONG_MEM_SIZE);
        $readmemh("midi_data/gy.txt", sequence_data, 3*SONG_MEM_SIZE);
