...
module sequencer (
    ...
    assign rand_range[1] = diff_rng_bounds[difficulty_ind] > delta_lane ? delta_lane : diff_rng_bounds[difficulty_ind]; //Upper bound clamped to delta-beat
    assign rand_range[0] = diff_rng_bounds[difficulty_ind+1] > delta_lane ? delta_lane : diff_rng_bounds[difficulty_ind+1];
